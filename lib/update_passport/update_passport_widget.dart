...
class UpdatePassportWidget extends StatefulWidget {
  const UpdatePassportWidget({
    Key key,
    this.ppParameter,
  }) : super(key: key);

  final DocumentReference ppParameter;
...
class _UpdatePassportWidgetState extends State<UpdatePassportWidget> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<UserDocumentsRecord>(
      stream: UserDocumentsRecord.getDocument(widget.ppParameter),
      builder: (context, snapshot) {
        ...
        final updatePassportUserDocumentsRecord = snapshot.data;
        return Scaffold(
          key: scaffoldKey,
          appBar: AppBar(
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        child: InkWell(
                                          ...
                                          child: ClipRRect(
                                            ...
                                            child: Image.network(
                                              updatePassportUserDocumentsRecord
                                                  .pPImage,
                                              width: double.infinity,
                                              height: 200,
                                              fit: BoxFit.cover,
                                      ...
                                      Padding(
                                        ...
                                        child: FFButtonWidget(
                                          onPressed: () async {
                                            if (updatePassportUserDocumentsRecord !=
                                                null) {
                                              final userDocumentsUpdateData =
                                                  createUserDocumentsRecordData(
                                                pPNo: passportNoController
                                                        ?.text ??
                                                    '',
                                                pPDate:
                                                    updatePassportUserDocumentsRecord
                                                ...
                                                pPUploadDate:
                                                    getCurrentTimestamp,
                                                pPImage: uploadedFileUrl,
                                              );
                                              await updatePassportUserDocumentsRecord
                                                  .reference
                                                  .update(
                                            ...
                                            context.pushNamed('UpdatePassport');
                                          },
                                          text: 'Confirm\n',
